...
-- Database: PostgreSQL
-- Generated at: 2026-09-11T11:27:37.615Z
...
ALTER TABLE "verify_emails" ADD FOREIGN KEY ("username") REFERENCES "user" ("username") DEFERRABLE INITIALLY IMMEDIATE;
...
ALTER TABLE "sessions" ADD FOREIGN KEY ("username") REFERENCES "user" ("username") DEFERRABLE INITIALLY IMMEDIATE;
